...
#[derive(Debug)]
pub struct DriftCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DriftCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DriftCore processing");
    
    let mut processor = DriftCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DriftCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DriftCoreProcessor::new(false);
